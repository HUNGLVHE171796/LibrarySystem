...
@WebServlet(name = "MuonTraSachChiTiet", urlPatterns = {"/MuonTraSachChiTiet", "/MuonTraSachChiTiet/delete",
    ...
    "/MuonTraSachChiTiet/edit", "/MuonTraSachChiTiet/add"})
public class BLLMuonTraSachChiTiet extends HttpServlet {
        ...
        try {
            switch (action) {
                ...
                case "/MuonTraSachChiTiet/update":
                    ...
                    break;
                case "/MuonTraSachChiTiet/add":
                    addMuonTraSachChiTiet(request, response);
                    break;
                default: // list
    ...
    private void addMuonTraSachChiTiet(HttpServletRequest request, HttpServletResponse response)
            throws SQLException, IOException {
