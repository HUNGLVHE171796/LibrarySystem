...
public class DALDocGia extends ConnectDatabase implements I_DAL<DocGia> {
	...
	public DALDocGia() throws SQLException {
        super();
    }
  ...
  public static void main(String[] args) {
        try {
            ...
            DocGia docGia = new DocGia();
            docGia.setMaDocGia(1);
            docGia.setTenDocGia("Nguyen Van A");
            docGia.setGioiTinh("Nam");
            docGia.setNgaySinh(Date.valueOf("1990-01-01"));
            docGia.setDiaChi("123 Nguyen Trai, Ha Noi");
            docGia.setEmail("nguyenvana@gmail.com");
            docGia.setSoDienThoai("1123456789");

            // Tạo đối tượng DALDocGia và gọi phương thức Add
            DALDocGia dalDocGia = new DALDocGia();
            int result = dalDocGia.Add(docGia);
