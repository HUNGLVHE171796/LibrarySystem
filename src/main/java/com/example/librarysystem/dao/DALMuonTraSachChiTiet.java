...
public class DALMuonTraSachChiTiet extends ConnectDatabase implements I_DAL<MuonTraSachChiTiet> {
    ...
    public DALMuonTraSachChiTiet() throws SQLException {
        super();
    }
    ...
    public List<MuonTraSachChiTiet> getAllChiTietByMaThe(int maThe) throws SQLException, ClassNotFoundException {
        openConnection();
        List<MuonTraSachChiTiet> MuonTraSachChiTiets = new ArrayList<>();
        String sqlExec = "EXEC spLayMuonTraSachChiTietByMaThe ?";
        PreparedStatement statement = jdbcConnection.prepareStatement(sqlExec);
        statement.setEscapeProcessing(true);
        statement.setQueryTimeout(15);
