					...
					<div class="modal-body">
						...
						<c:if test="${dauSachIU != null }">
							<div class="row">
								<div class="form-group col-md-6">
									<img alt="Not found"
										src="http://localhost:9999/QuanLyThuVien/getAnhBia?maDauSach=${dauSachIU.getMaDauSach() }"
										width="200px" height="200px">
								</div>
								<div class="form-group col-md-6">
									<img alt="Not found"
										src="http://localhost:9999/QuanLyThuVien/getAnhTacGia?maDauSach=${dauSachIU.getMaDauSach() }"
													...
													<c:forEach var="dauSach" items="${listDauSach}">
														<tr>
															...
															<td><img alt="Not found"
																src="http://localhost:9999/QuanLyThuVien/getAnhTacGia?maDauSach=${dauSach.getMaDauSach() }"
																width="100px" height="100px"></td>
															<td><c:out value="${dauSach.getNamXuatBan()}" /></td>
															<td><c:out value="${dauSach.getNgonNgu()}" /></td>
															<%-- <td><c:out value="${dauSach.getAnhBiaBlob()}" /></td> --%>
															<td><img alt="Not found"
																src="http://localhost:9999/QuanLyThuVien/getAnhBia?maDauSach=${dauSach.getMaDauSach() }"
