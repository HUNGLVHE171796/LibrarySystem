...
<!-- Mirrored from gramentheme.com/html/bookle/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 06:03:58 GMT -->
<head>
  <!-- ========== Meta Tags ========== -->
  <meta charset="UTF-8">
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        <ul class="submenu">
                          ...
                          <li><a href="borrowlist.jsp">Shop Cart</a></li>
          ...
          <div class="col-6 col-xl-3">
            <div class="header-right">
              ...
              <div class="menu-cart">
                ...
                <a href="borrowlist.jsp" class="cart-icon">
    ...
    <div class="header-2-wrapper">
      ...
      <div class="header-2-right">
        ...
        <div class="author-icon">
          <div class="icon">
            <img src="img/icon/icon-23.svg" alt="icon">
          </div>
          <div class="content">
      ...
      <div class="col-12 col-xl-6 col-lg-6">
        <div class="hero-items">
          <div class="frame-shape1 float-bob-x">
            <img src="img/hero/hero2-shape1.png" alt="shape-img">
          </div>
          <div class="frame-shape2 float-bob-y">
            <img src="img/hero/hero2-shape2.png" alt="shape-img">
          </div>
          <div class="book-image">
            <img src="img/hero/hero-book.png" alt="img">
          </div>
    ...
    <div class="row g-4">
      <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
        <div class="banner-book-card-items bg-cover"
             style="background-image: url('img/banner/book-banner-1.jpg');">
          <div class="book-shape">
            <img src="img/banner/book-1.png" alt="img">
          </div>
      ...
      <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".5s">
        <div class="banner-book-card-items bg-cover"
             style="background-image: url('img/banner/book-banner-2.jpg');">
          <div class="book-shape">
            <img src="img/banner/book-2.png" alt="img">
          </div>
          <div class="banner-book-content">
      ...
      <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".7s">
        <div class="banner-book-card-items bg-cover"
             style="background-image: url('img/banner/book-banner-3.jpg');">
          <div class="book-shape">
            <img src="img/banner/book-3.png" alt="img">
          </div>
          <div class="banner-book-content">
            <h2>
              Grow With <br>
    ...
    <div class="swiper book-slider">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="shop-box-items style-2">
            <div class="book-thumb center">
              <a href="shop-details-2.html"><img src="img/book/01.png" alt="img"></a>
              <ul class="post-box">
                <li>
                  Hot
                </li>
              ...
              <ul class="shop-icon d-grid justify-content-center align-items-center">
                <li>
                  <a href="borrowlist.jsp"><i class="far fa-heart"></i></a>
                </li>
                <li>
                  <a href="borrowlist.jsp">
                    <img class="icon" src="img/icon/shuffle.svg" alt="svg-icon">
                  </a>
                </li>
                <li>
            ...
            <div class="shop-content">
              ...
              <ul class="author-post">
                <li class="authot-list">
                                        <span class="thumb">
                                            <img src="img/testimonial/client-1.png" alt="img">
                                        </span>
        ...
        <div class="swiper-slide">
          <div class="shop-box-items style-2">
            <div class="book-thumb center">
              <a href="shop-details-2.html"><img src="img/book/02.png" alt="img"></a>
              <ul class="shop-icon d-grid justify-content-center align-items-center">
                <li>
                  <a href="borrowlist.jsp"><i class="far fa-heart"></i></a>
                </li>
            ...
            <div class="shop-content">
              ...
              <ul class="author-post">
                <li class="authot-list">
                                        <span class="thumb">
                                            <img src="img/testimonial/client-2.png" alt="img">
                                        </span>
        ...
        <div class="swiper-slide">
          <div class="shop-box-items style-2">
            <div class="book-thumb center">
              <a href="shop-details-2.html"><img src="img/book/03.png" alt="img"></a>
              <ul class="shop-icon d-grid justify-content-center align-items-center">
                <li>
                  <a href="borrowlist.jsp"><i class="far fa-heart"></i></a>
                </li>
            ...
            <div class="shop-content">
              ...
              <ul class="author-post">
                <li class="authot-list">
                                        <span class="thumb">
                                            <img src="img/testimonial/client-3.png" alt="img">
                                        </span>
        ...
        <div class="swiper-slide">
          <div class="shop-box-items style-2">
            <div class="book-thumb center">
              <a href="shop-details-2.html"><img src="img/book/04.png" alt="img"></a>
              <ul class="post-box">
                <li>
                  -12%
                </li>
            ...
            <div class="shop-content">
              ...
              <ul class="author-post">
                <li class="authot-list">
                                        <span class="thumb">
                                            <img src="img/testimonial/client-4.png" alt="img">
                                        </span>
        ...
        <div class="swiper-slide">
          <div class="shop-box-items style-2">
            <div class="book-thumb center">
              <a href="shop-details-2.html"><img src="img/book/05.png" alt="img"></a>
              <ul class="shop-icon d-grid justify-content-center align-items-center">
                <li>
                  <a href="borrowlist.jsp"><i class="far fa-heart"></i></a>
                </li>
            ...
            <div class="shop-content">
              ...
              <ul class="author-post">
                <li class="authot-list">
                                        <span class="thumb">
                                            <img src="img/testimonial/client-5.png" alt="img">
                                        </span>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="shop-box-items style-4 wow fadeInUp" data-wow-delay=".2s">
            <div class="book-thumb center">
              <a href="shop-details-2.html"><img src="img/book/07.png" alt="img"></a>
            </div>
            <div class="shop-content">
        ...
        <div class="swiper-slide">
          <div class="shop-box-items style-4 wow fadeInUp" data-wow-delay=".2s">
            <div class="book-thumb center">
              <a href="shop-details-2.html"><img src="img/book/11.png" alt="img"></a>
            </div>
            <div class="shop-content">
              <ul class="book-category">
                <li class="book-category-badge">Adventure</li>
        ...
        <div class="swiper-slide">
          <div class="shop-box-items style-4 wow fadeInUp" data-wow-delay=".2s">
            <div class="book-thumb center">
              <a href="shop-details-2.html"><img src="img/book/10.png" alt="img"></a>
            </div>
            <div class="shop-content">
              <ul class="book-category">
                <li class="book-category-badge">Adventure</li>
  ...
  <div class="container">
    ...
    <div class="book-shop-wrapper style-2">
      ...
      <div class="shop-box-items style-3 wow fadeInUp" data-wow-delay=".4s">
        <div class="book-thumb center">
          <a href="shop-details-2.html"><img src="img/book/08.png" alt="img"></a>
        </div>
        <div class="shop-content">
          <ul class="book-category">
            <li class="book-category-badge">Adventure</li>
      ...
      <div class="shop-box-items style-3 wow fadeInUp" data-wow-delay=".6s">
        <div class="book-thumb center">
          <a href="shop-details-2.html"><img src="img/book/09.png" alt="img"></a>
        </div>
        <div class="shop-content">
          <ul class="book-category">
            <li class="book-category-badge">Adventure</li>
    ...
    <div class="book-shop-wrapper">
      ...
      <div class="cta-shop-box">
        <div class="girl-shape">
          <img src="img/boy-shape.png" alt="shape-img">
        </div>
      </div>
    </div>
  </div>
...
<section class="cta-banner-section fix section-padding pt-0">
  <div class="container">
    <div class="cta-banner-wrapper style-2 section-padding bg-cover"
         style="background-image: url('img/cta-banner2.jpg');">
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="team-box-items">
            <div class="team-image">
              <div class="thumb">
                <img src="img/team/01.jpg" alt="img">
              </div>
              <div class="shape-img">
                <img src="img/team/shape-img.png" alt="img">
              </div>
            </div>
        ...
        <div class="swiper-slide">
          <div class="team-box-items">
            <div class="team-image">
              <div class="thumb">
                <img src="img/team/02.jpg" alt="img">
              </div>
              <div class="shape-img">
                <img src="img/team/shape-img.png" alt="img">
              </div>
        ...
        <div class="swiper-slide">
          <div class="team-box-items">
            <div class="team-image">
              <div class="thumb">
                <img src="img/team/03.jpg" alt="img">
              </div>
              <div class="shape-img">
                <img src="img/team/shape-img.png" alt="img">
              </div>
        ...
        <div class="swiper-slide">
          <div class="team-box-items">
            <div class="team-image">
              <div class="thumb">
                <img src="img/team/04.jpg" alt="img">
              </div>
              <div class="shape-img">
                <img src="img/team/shape-img.png" alt="img">
              </div>
        ...
        <div class="swiper-slide">
          <div class="team-box-items">
            <div class="team-image">
              <div class="thumb">
                <img src="img/team/05.jpg" alt="img">
              </div>
              <div class="shape-img">
                <img src="img/team/shape-img.png" alt="img">
              </div>
        ...
        <div class="swiper-slide">
          <div class="team-box-items">
            <div class="team-image">
              <div class="thumb">
                <img src="img/team/06.jpg" alt="img">
              </div>
              <div class="shape-img">
                <img src="img/team/shape-img.png" alt="img">
              </div>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
        <div class="news-card-items">
          <div class="news-image">
            <img src="img/news/09.jpg" alt="img">
            <img src="img/news/09.jpg" alt="img">
            <div class="post-box">
              Activities
            </div>
      ...
      <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
        <div class="news-card-items">
          <div class="news-image">
            <img src="img/news/10.jpg" alt="img">
            <img src="img/news/10.jpg" alt="img">
            <div class="post-box">
              Activities
            </div>
      ...
      <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".6s">
        <div class="news-card-items">
          <div class="news-image">
            <img src="img/news/11.jpg" alt="img">
            <img src="img/news/11.jpg" alt="img">
            <div class="post-box">
              Activities
            </div>
      ...
      <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".8s">
        <div class="news-card-items">
          <div class="news-image">
            <img src="img/news/12.jpg" alt="img">
            <img src="img/news/12.jpg" alt="img">
            <div class="post-box">
              Activities
            </div>
...
<!-- Mirrored from gramentheme.com/html/bookle/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 06:04:27 GMT -->
</html>