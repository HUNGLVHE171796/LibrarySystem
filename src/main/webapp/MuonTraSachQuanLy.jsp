...
<body class="animsition">
	<div class="page-wrapper">
				...
				<div class="container-fluid">
					<div class="header-mobile-inner">
						<a class="logo" href="index.html"> <c:if
								test="${muonTraSachIU != null }">
								<img src="../images/icon/logo.png" alt="CoolAdmin" />
							</c:if> <c:if test="${muonTraSachIU == null }">
								<img src="./images/icon/logo.png" alt="CoolAdmin" />
							</c:if>
						</a>
		...
		<aside class="menu-sidebar d-none d-lg-block">
			<div class="logo">
				<a href="#"> <c:if test="${muonTraSachIU != null }">
					...
					<div class="modal-header">
						<c:if test="${muonTraSachIU != null }">
							<h3 class="modal-title" id="InsertLabel"
								style="font-family: 'Roboto';">Sửa mượn trả sách</h3>
						</c:if>
						<c:if test="${muonTraSachIU == null }">
							<h3 class="modal-title" id="InsertLabel"
								style="font-family: 'Roboto';">Thêm mượn trả sách</h3>
						</c:if>
					...
					<div class="modal-body">
						<div class="row">
							<div class="form-group col-md-4">
								...
								<c:if test="${muonTraSachIU != null }">
									<input type="text" name="txtMaMuonSach" required="required"
										...
										value="${muonTraSachIU.getMaMuonSach() }">
								</c:if>
								<c:if test="${muonTraSachIU == null }">
									<input type="text" name="txtMaMuonSach" required="required"
							...
							<div class="form-group col-md-4">
								<label>Tiền Đặt Cọc</label> <input type="number"
									name="numberTienDatCoc" class="form-control" step="1000"
									required="required" pattern="[0-9]" title="" min="1000"
									value="${muonTraSachIU.getTienDatCoc() }">
						...
						<div class="row">
							<div class="form-group col-md-12">
								<label>Ghi Chú</label>
								<textarea rows="5" id="txtGhiChu" name="txtGhiChu"
									class="col-md-12 form-control" style="border: solid 1px green;"></textarea>
								<script type="text/javascript">
									document.getElementById("txtGhiChu").value = "${muonTraSachIU.getGhiChu()}";
								</script>
							</div>
						</div>
				...
				<div class="header-button pull-right">
					...
					<div class="account-wrap">
						<div class="account-item clearfix js-item-menu">
							...
							<div class="content">
								<a class="js-acc-btn" href="#">Library Management</a>
							</div>
							<div class="account-dropdown js-dropdown">
								...
								<div class="account-dropdown__body">
									<div class="account-dropdown__item">
										<a href="UserProfile.jsp"> <i class="zmdi zmdi-account"></i>Account
										</a>
									</div>
									<div class="account-dropdown__item">
									...
									<div class="col-12 col-md-12">
										<div class="table-responsive table--no-card m-b-30">
											<table style="width: 100%"
												...
												<tbody>
													<c:forEach var="muonTraSach" items="${listMuonTraSach}">
														<tr>
															<td><c:out value="${muonTraSach.getMaMuonSach()}" /></td>
															<td><c:out value="${muonTraSach.getMaThe()}" /></td>
															<td><c:out value="${muonTraSach.getTienDatCoc()}" /></td>
															...
															<td><a class="btn btn-warning pull-left"
																...
																href="/QuanLyThuVien/MuonTraSachQuanLy/delete?maMuonSach=<c:out value='${muonTraSach.getMaMuonSach()}' />&pages=<c:out value="${soTrangHienTai}" />">Xóa</a>
															<a class="btn btn-secondary"
																href="/QuanLyThuVien/MuonTraSachChiTiet" />Thêm</a>
                                                                                                                        </td>
														</tr>
													</c:forEach>
												</tbody>
											...
											<div class="shop-pagination pull-right">
												<ul id="" class="pagination-sm pagination">
													<li class="page-item first"><a
														href="/QuanLyThuVien/MuonTraSachQuanLy?pages=1"
